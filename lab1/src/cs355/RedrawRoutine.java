...
class RedrawRoutine implements Runnable
{
	...
	// If you ever need to make sure the view is not being redrawn while you do
	// work under the hood,
	...
	public void refreshView()
	{
		...
		bufImage =
				gc.createCompatibleImage(screenCanvas.getWidth(),
						screenCanvas.getHeight());
	...
	public void run()
	{
		...
		{
			Logger.getLogger(RedrawRoutine.class.getName()).log(Level.SEVERE,
					null, ex);
			System.exit(-1);
		}
		while(true)
		{
			...
			{
				Logger.getLogger(RedrawRoutine.class.getName()).log(
