...
class CS355Frame extends javax.swing.JFrame
{
	...
	public static void createCS355Frame(CS355Controller c,
	...
	static CS355Frame inst()
	{
		if(instance == null)
		{
			throw new IllegalStateException(
					"Tried to get instance of CS355Frame without initializing it first!");
		}
		return instance;
	}
	...
	public static void main(String args[])
	{
		...
		{
			java.util.logging.Logger.getLogger(CS355Frame.class.getName()).log(
	...
	private CS355Frame(CS355Controller c, ViewRefresher viewRefresher,
			MouseListener mouseListener, MouseMotionListener mml)
	{
		initComponents();
		controller = c;
			...
			void initComponents()
	{
		...
		jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/cs355/res/Rectangle.png"))); // NOI18N
	...
	{// GEN-FIRST:event_jButton1ActionPerformed
		Color c =
				JColorChooser.showDialog(rootPane, "Pick a Color; any Color!",
						Color.yellow);
	...
	void setScrollAttribute(CS355SScrollbarAttrConsts scrollBar,
			CS355SScrollbarAttrConsts attribute, int number)
	{
	...
	void setSelectedColor(Color c)
	{
		...
		{
			Logger.getLogger(CS355Frame.class.getName()).log(Level.SEVERE,
					null, ex);
		}
		System.out.println("c: " + c);
		Graphics2D toDrawOn = (Graphics2D) canvas2.getGraphics();
		toDrawOn.setColor(Color.BLACK);
		toDrawOn.fillRect(0, 0, canvas2.getSize().width,
				canvas2.getSize().height);
		toDrawOn.setColor(Color.white);
		toDrawOn.fillOval(1, 1, canvas2.getSize().width - 2,
				canvas2.getSize().height - 2);
		toDrawOn.setColor(c);
		toDrawOn.fillRect(0, 0, canvas2.getSize().width,
				canvas2.getSize().height);
	}
